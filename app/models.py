...
class CreatorProfile(models.Model):
	...
	slug = models.SlugField(max_length=1024,unique=True, blank=True, null=True)
...
class Tag(models.Model):
	...
	slug = models.SlugField(max_length=1024, blank=True, unique=True, null=True)
...
class Post(models.Model):
	...
	creator_profile = models.ForeignKey(CreatorProfile, related_name='posts', null=True, on_delete=models.CASCADE)
