...
urlpatterns = [
    ...
    path('creators/', views.CreatorProfileListView.as_view(),
         name='creator-profile-list-view'),
    path('creators/<slug:slug>/', views.CreatorProfileDetailView.as_view(),
         name='creator-profile-detail-view'),
